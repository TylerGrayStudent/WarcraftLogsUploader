 ...
 
{
	...
	"choose_livelog_directory_warcraft": "Choose the Logs subdirectory of your game installation:",
	"choose_livelog_directory_eso": "Choose the directory that ESO writes logs to (inside your Documents directory):",
	"choose_livelog_directory_swtor": "Choose the directory that SWTOR writes logs to (inside your Documents directory):",
	"choose_livelog_directory_ff": "Choose the directory that the ACT FFXIV plug-in writes logs to:",
	...
	"view_report_in_app_button": "View Report in App",
	...
	"processed_in_progress_fight": "Processed In Progress Fight",
	...
	"warcraft_difficulty_tower": "Tower",
	"live_version": "Dragonflight",
	"classic_version": "Wrath",
	...
	"character_viewer_desc3": "Select one of your characters from the <i>My Characters</i> sidebar.",
	...
	"change_hotkeys_description": "Change the in-game hotkeys that can be used for showing/hiding the overlay or calling a wipe.",
	"change_auto_launch": "Change Launch",
	"change_auto_launch_description": "Change whether the in-game companion app should automatically launch when the game is launched. The in-game app launches roughly 15 seconds after the game launches.",
	"close_overwolf_description": "When closing the companion app, also close Overwolf. This may result in the companion app (as well as other apps you have) not auto-launching when playing the relevant games. Overwolf will close 1 minute after closing the companion app, which allows your logging to be uninterrupted if you need to quickly re-open the app.",
	"sort_by": "Sort by:",
	...
	"update_complete": "Download complete.",
	"update_install": "Install and restart now.",
	"livelog_entirefile": "Include the Entire File in the Report",
	"livelog_realtime": "Enable Real-Time Uploading",
	"desktop": "Desktop",
	"ingame": "In-game",
	"welcome_to_wcl": "Welcome to the Warcraft Logs Companion.",
	"welcome_to_ffl": "Welcome to the FF Logs Companion.",
	"companion_app_features": "Upload your logs and view reports, characters, and guilds directly from the app!",
	"reopen_wcl_companion_instructions": "You can re-open this window through Overwolf, or by clicking on the Warcraft Logs logo when in-game.",
	"reopen_ffl_companion_instructions": "You can re-open this window through Overwolf, or by clicking on the FF Logs logo when in-game.",
	"explore_the_app": "Explore the App",
	"return_to_game": "Return to Game",
	"log_operation_in_progress_warning": "This will cancel your current logging operation. Do you still wish to proceed?"
}
